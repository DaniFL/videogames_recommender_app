                ...
                <div className="flex items-center gap-9">
                    {isAuthenticated ? (
                        <>
                            ...
                            <Link className="text-white text-sm font-medium leading-normal" to="/library">Noticias</Link>
            ...
            <div className="relative flex flex-1 justify-end gap-8">
                {isAuthenticated && (
                    <div>
                        ...
                        ></div>
                        {menuOpen && (
                            <div className="absolute right-0 mt-2 w-48 bg-[#283039] rounded-lg shadow-lg">
                                <Link
                                    to="/user-settings"
                                    className="block px-4 py-2 text-white hover:bg-[#111418]"
                                >
